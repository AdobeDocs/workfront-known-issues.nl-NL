...
>[!NOTE]
>
>Voor informatie over onderhoudstekorten voor alle producten van de Adobe, met inbegrip van Workfront, zie de [&#x200B; pagina van de Status van de Adobe &#x200B;](https://status.adobe.com/nl-nl/).
...
**Fouten in de rapporten van het Project (Financiële Gegevens)**

Een kintenfout verschijnt periodiek voor de rapporten van het Project (Financiële Gegevens), in zowel de detailpagina als de matrixpagina.

Als deel van het verbeteren van deze kwestie, worden de projecten in dit rapporttype niet meer automatisch opnieuw berekend alvorens de gegevens te laden. Gebruikers moeten de financiën van afzonderlijke projecten handmatig opnieuw berekenen om de gegevens in een financieel gegevensrapport bij te werken.
...
### Onderhoudsupdate op 7 november 2024
...
### Onderhoudsupdate op 19 september 2024

#### Dashboards

**Selecterend de knoop van de Uitvoer in een rapport scrolt aan bovenkant van pagina**
...
+++**Update van het Onderhoud op 29 augustus, 2024**

### Onderhoudsupdate op 29 augustus 2024
...
### Onderhoudsupdate op 8 augustus 2024
...
### Onderhoudsupdate op 1 augustus 2024
...
### Onderhoudsupdate op 25 juli 2024
