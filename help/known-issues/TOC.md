...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Huidige problemen in [!DNL Adobe Workfront] {#wf-current}
      + [Rapportage: gebruikers kunnen financiële gegevens bekijken in de visualisaties van het dashboard van het Canvas](known-issues-workfront/wf-reporting-users-can-see-financial-date.md)
