...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Huidige problemen in [!DNL Adobe Workfront] {#wf-current}
      + [Gebruikers: gedeactiveerde of verwijderde gebruikers worden als actief weergegeven in Snowflake](/help/known-issues/known-issues-workfront/wf-users-deactivated-appear-in-snowflake.md)
