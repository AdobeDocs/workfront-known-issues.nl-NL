...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Huidige problemen in [!DNL Adobe Workfront] {#wf-current}
      ...
      + [Documenten: kan documenten niet verplaatsen van het tabblad Objectdocumenten](known-issues-workfront/wf-documents-cannot-move-from-object.md)
      ...
      + [Prioriteiten: groepen voorkomen sorteren en inline bewerken](known-issues-workfront/wf-home-priorities-grouping-limitations.md)
      + [Aanmelden als omleiding naar aanmelding of veroorzaakt een fout](known-issues-workfront/wf-login-as-redirects-to-login.md)
      ...
      + [Startpagina: &quot;widget.list.view&quot; gemaakt wanneer de gebruiker kolommen verplaatst in de widget Home](known-issues-workfront/wf-home-widget-list-view.md)
      ...
      + [Start: widget voor openstaande goedkeuringen toont verwijderde documenten](known-issues-workfront/wf-home-deleted-documents.md)
      + [Start: &quot;Geen toegang&quot; wordt weergegeven als projectnaam](known-issues-workfront/wf-home-no-access-project-name.md)
      + [Documenten: kan geen voorvertoning van documenten weergeven met voorvertoningskoppeling](known-issues-workfront/wf-documents-cannot-preview-by-pasting-link.md)
      + [Aangepaste formulieren: conversiefout van type weergeven op aangepaste formulieren](known-issues-workfront/wf-custom-forms-cannot-create-or-save-form-with-rich-text.md)
      ...
      + [Verzoeken: de gebruiker kan de status wijzigen ondanks een gebrek aan machtigingen](known-issues-workfront/wf-requests-user-can-change-status-without-permissions.md)
      + [Boards: Verbonden kaart bevindt zich in onjuiste kolom](known-issues-workfront/wf-boards-connected-card-incorrect-column.md)
      ...
      + [Toegangsniveaus: toegangsniveaus dupliceren in Setup-gebied](known-issues-workfront/wf-access-duplicate-level.md)
      ...
      + [Proefversies: goedgekeurde proefdrukken worden weergegeven in rapporten](known-issues-workfront/wf-proofs-approved-showing-on-reports.md)
      + [Kan geen weergave voor documentenlijst maken](known-issues-workfront/wf-documents-cannot-add-new-view.md)
      + [Gegraveerd: het artikelbord wordt leeg wanneer u een subtaak toevoegt](known-issues-workfront/wf-agile-blank-screen-when-adding-subtask.md)
      ...
      + [Boards: board wordt niet als gebruiker weergegeven bij gebruik van [!UICONTROL Log in as]](known-issues-workfront/wf-boards-log-in-as.md)
      + [Home: De widget Mijn problemen geeft geen gesloten of voltooide problemen weer](known-issues-workfront/inactive/wf-home-issues-widget-not-display-completed.md)
      ...
      + [Rapporten: &quot;Geen gegevens om weer te geven&quot; wanneer de naam van de groepering een schuine streep naar voren of naar achteren heeft](known-issues-workfront/wf-reports-chart-drilldown-had-no-data.md)
      + [Integraties: problemen met Dropbox-integratie](known-issues-workfront/wf-integrations-issues-with-dropbox.md)
      + [Rapporten: fout bij het weergeven van rapportgegevens die zijn gegroepeerd op aangepaste datum](known-issues-workfront/wf-reports-error-with-custom-date-field.md)
      + [Home: De widget voor goedkeuringen is niet nauwkeurig](known-issues-workfront/wf-home-approvals-widget-not-up-to-date.md)
      + [Resourceplanning: knop [!UICONTROL More] is niet zichtbaar](known-issues-workfront/wf-resource-management-more-button-not-visible.md)
      ...
      + [De datum van werkelijke voltooiing wordt weergegeven als n.v.t.](known-issues-workfront/wf-projects-completion-date-is-na.md)
      + [Taken: de taakrol verdwijnt niet uit de lijst wanneer de gebruiker aan een taak wordt toegewezen](known-issues-workfront/wf-tasks-assigning-user-with-role.md)
      ...
      + [Layout sjabloon: bestemmingspagina is onjuist](known-issues-workfront/wf-layout-template-set-to-home-not-request.md)
      ...
      + [Boards: kaart bevat geen subtaken](known-issues-workfront/wf-boards-subtasks-do-not-display.md)
      ...
      + [Proofs: [!UICONTROL Proof Activity] tabblad wordt geopend [!UICONTROL Proof Details]](known-issues-workfront/inactive/wf-proofs-proofing-activity-redirects-to-details.md)
      ...
      + [Documenten: 404 fout bij openen van document gekoppeld vanuit  [!DNL SharePoint]](known-issues-workfront/inactive/wf-documents-404-when-accessing-document-in-sharepoint.md)
      ...
      + [[!UICONTROL Workload Balancer]: uren worden niet aangepast om rekening te houden met vrije tijd van gebruiker](known-issues-workfront/inactive/wf-workload-balancer-assigned-hours-not-adjusting-for-pto.md)
      ...
      + [Documenten: Rechten worden niet overgeërfd wanneer een document wordt verplaatst naar een nieuw project](known-issues-workfront/inactive/wf-documents-permissions-not-interited-when-moved.md)
      ...
      + [E-mailmeldingen: e-mails hebben niet de juiste opmaak in  [!DNL Outlook]](known-issues-workfront/inactive/wf-email-notif-not-formatting-in-outlook.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Huidige problemen in [!DNL Workfront Proof] {#proof-current}
      ...
      + [[!UICONTROL Home]: voltooide proefdrukken vastgezet in de [!UICONTROL Work List]](known-issues-workfront-proof/completed-proofs-stuck-in-the-work-list.md)
   ...
   + Opgeloste problemen in [!DNL Workfront] Proef {#proof-resolved}
      + [Proofs: proefdrukken worden over een te lange periode weergegeven als &quot;[!UICONTROL Generating proof]&quot;](known-issues-workfront-proof/resolved-issues-proof/generating-proof-for-excessive-amounts-of-time.md)


+ [!DNL Adobe Workfront Fusion] {#fusion}
   + [Bekende problemen in Workfront Fusion](workfrontfusion.md)
   + Huidige problemen in [!DNL Workfront Fusion] {#fusion-current}
      + [Workfront Fusion: stel &quot;Van nu af aan&quot; in voor het verwerken van alle gegevens](known-issues-workfront-fusion/fusion-from-now-on-processing-all-data.md)
