...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Huidige problemen in [!DNL Adobe Workfront] {#wf-current}
      + [Home: Onthoudingen van proefdrukken worden niet weergegeven in de widget voor herinneringen](known-issues-workfront/wf-home-mentions-from-proofs-not-in-widget.md)
      + [Integraties: Slack-meldingen van Workfront leiden niet tot](known-issues-workfront/wf-integrations-slack-notifications-not-triggering.md)
      + [Goedkeuringen: kan document niet goedkeuren vanuit de widget Mijn goedkeuringen thuis](known-issues-workfront/wf-approval-not-work-from-widget.md)
      + [Workfront Planning: fout bij verzenden van aanvraag](/help/known-issues/known-issues-workfront/wf-planning-error-fail-to-submit-request.md)
      + [Goedkeuringen: goedkeuringen worden automatisch vergrendeld](known-issues-workfront/wf-approvals-are-locked.md)
      + [Toewijzingen: kan geavanceerde toewijzingswijziging niet opslaan vanuit een rapport](known-issues-workfront/wf-assignments-cannot-save-advanced-from-report.md)
      + [Rapportage: Workfront-planningsvelden worden niet weergegeven in de rapportbuilder van Canvas-dashboards](known-issues-workfront/wf-reporting-canvas-dashboards-no-planning.md)
      + [Gebruikers: directe rapporten kunnen niet worden verwijderd](known-issues-workfront/wf-users-cannot-remove-direct-reports.md)
      + [Verzoeken: kan een document niet uploaden wanneer u een aanvraag invult](known-issues-workfront/wf-request-cannot-submit-with-document.md)
      + [Verzoeken: &quot;Geen onderwerp&quot; wordt weergegeven in aanvraaglijst](known-issues-workfront/wf-requests-no-subject.md)
      ...
      + [Aangepaste formulieren: berekende velden geven geen gegevens voor niet-beheerders weer](known-issues-workfront/wf-custom-forms-calculated-fields-admin-only.md)
      + [Verzoeken: Concept wordt samen met verzoek gemaakt, veroorzaakt problemen](known-issues-workfront/wf-requests-draft-created-with-request.md)
      + [Aanvragen: &quot;U moet een systeembeheerfout zijn&quot; bij het kopiëren van aanvragen](known-issues-workfront/wf-requests-error-when-copying.md)
      + [Gebruikers: gebruikers zijn niet correct ingericht op de Adobe Admin Console](known-issues-workfront/wf-users-on-other-consoles-not-provisioning.md)
      + [Verzoeken: Problemen met concepten in de nieuwe verzoekende ervaring](known-issues-workfront/wf-requests-issues-with-drafts.md)
      + [Verzoeken: Vragenrijen worden meerdere keren weergegeven](known-issues-workfront/wf-requests-queues-duplicated.md)
      ...
      + [Rapporten: De vraag van het meer van gegevens keert geen verwachte resultaten terug](known-issues-workfront/wf-reports-data-lake-not-return-expected-results.md)
      + [Rapportage: gebruikers kunnen financiële gegevens bekijken in de visualisaties van het dashboard van het Canvas](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Workfront-planning: kan geen veld toevoegen aan een weergave](known-issues-workfront/wf-planning-cannot-add-field.md)
      + [Goedkeuringen: Mijn widget Goedkeuringen toont voltooide goedkeuringen](known-issues-workfront/wf-approvals-widget-shows-approved-documents.md)
      + [Workfront-planning: fout bij verwijderen van verbonden veld](known-issues-workfront/wf-planning-cannot-delete-connected-field.md)
      + [Gebruikers: optie voor het automatisch genereren van proefdrukken ontbreekt in gebruikersprofiel](known-issues-workfront/wf-users-no-option-to-automatically-generate-proofs.md)
      + [Aangepaste formulieren: Kan RTF-velden niet bewerken](known-issues-workfront/wf-custom-forms-cannot-edit-rich-text-field.md)
      + [Gebruikers: Fout bij openen van gebruikerspagina](known-issues-workfront/wf-users-cannot-open-user-tab.md)
      + [Taken: Kan gebruikersrol niet selecteren bij het maken van een taak](known-issues-workfront/wf-tasks-cannot-assign-user-role.md)
      + [Proefdrukken: wijzigingen in de status van proefdrukken worden vertraagd](known-issues-workfront/wf-proof-status-sync-delayed.md)
      + [Taken: Inline-bewerkingen op een taak worden niet opgeslagen](known-issues-workfront/wf-tasks-inline-changes-not-saving.md)
      + [Gebruikers: gebruikers die bulksgewijs bewerken verwijderen brongroepen en directe rapporten](known-issues-workfront/wf-users-bulk-editing-clears-resource-pools.md)
      + [Verzoeken: kan document niet uploaden om van GDrive te verzoeken](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md)
      + [Taken: Bewerkingen aan het gedeelte Toewijzingen van een taak worden niet opgeslagen](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md)
      + [Gebruikers: problemen met wijzigingen in proefdrukprofiel](known-issues-workfront/wf-users-proof-profile-changes-not-retained.md)
      + [Verzoeken: Rechten die niet worden overgeërfd bij het maken van een aanvraag](known-issues-workfront/wf-requests-permissions-not-inherited.md)
      ...
      + [Gebruikers: kunnen alleen taakrollen zoeken op eerste woord](known-issues-workfront/wf-users-job-role-first-word.md)
      ...
      + [Goedkeuringen: goedkeuring wordt weergegeven als &quot;Geen deadline&quot; wanneer de tijd niet is opgenomen in de deadline](/help/known-issues/known-issues-workfront/wf-approvals-displays-no-deadline-if-no-time.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Huidige problemen in [!DNL Workfront Proof] {#proof-current}
      + [Workfront Proof: proefdrukken worden niet weergegeven in mappen](known-issues-workfront-proof/proof-folders-not-showing-proofs.md)
